...
const Menu = () => {
  return (
    <div className="bg-white ">
      ...
      <main className="bg-white min-w-min max-w-screen max-h-max m-auto px-20 py-32">
        ...
        <div className="text-center mb-32">
          ...
          <h2 className="pt-5 text-black">Discover a variety of teas crafted to meet your specific needs, each with a unique purpose.</h2>
        </div>

        <div className="flex flex-col md:flex-row justify-center gap-12 md:space-x-8 px-6 ">
          {/* Beauty Teas */}
          <Link href="/beauty">
    ...
    <Image src="/photos/beauty/beauty.PNG" alt="Beauty Teas" width={300} height={300} className="min-w-fill mx-auto rounded-lg" />
    ...
    Contains: Biotin and Collagen
          ...
          <Link href="/specialty">
  <div className="bg-white p-6 rounded-lg shadow-lg transition-shadow border-2 border-opacity-0 transition-border duration-300 hover:shadow-lg hover:shadow-orange-500/50 hover:border-1 hover:border-orange-500 hover:border-opacity-20 hover:filter ">
    <Image src="/photos/specialty/liam.PNG" alt="Specialty Teas" width={300} height={300} className="min-w-fill mx-auto rounded-lg" />
    <h2 className="text-2xl font-semibold text-center mb-4">Specialty Teas</h2>
    <p className="text-gray-600 text-left">
      Each crafted to deliver unique flavors and health benefits.<br></br> Perfect for any tea enthusiast.<br/>
      <br />
      Calories: 100<br />
      Protein: 17g <br />
      Net Carbs: 9-10g<br />
  ...
  <Link href="/meal">
  <div className="bg-white p-6 rounded-lg shadow-lg transition-shadow border-2 border-opacity-0 transition-border duration-300 hover:shadow-lg hover:shadow-orange-500/50 hover:border-1 hover:border-orange-500 hover:border-opacity-20 hover:filter ">
    <Image src="/photos/meal/blueberry.PNG" alt="Meal Replacement Shakes" width={300} height={300} className="min-w-fill mx-auto rounded-lg" />
    ...
    <p className="text-gray-600 text-left">
      ...
      Net Carbs: 9-10g
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-opacity-0 transition-shadow transition-border duration-300 hover:shadow-lg hover:shadow-orange-500/50 hover:border-1 hover:border-orange-500 hover:border-opacity-20 hover:filter ">
            <Image src="/photos/loaded/november.PNG" alt="Loaded Teas" width={300} height={200} className="min-w-fill mx-auto rounded-lg" />
      ...
      Caffeine: 200mg
          ...
          <Link href="/allinone">
          <div className="bg-white p-6 rounded-lg shadow-lg transition-shadow border-2 border-opacity-0 transition-border duration-300 hover:shadow-lg hover:shadow-orange-500/50 hover:border-1 hover:border-orange-500 hover:border-opacity-20 hover:filter ">
    <Image src="/photos/allinone/carnival.PNG" alt="Beauty Teas" width={300} height={300} className="min-w-fill mx-auto rounded-lg" />
